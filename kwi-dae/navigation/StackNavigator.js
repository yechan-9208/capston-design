  ...
  const getData = (area) => {
    ...
    return (
        ...
        >
            ...
            {/* <Stack.Screen name="메인 페이지" children={()=> <MainPage area={area} getData={getData} />}/> */}
            
            <Stack.Screen name="K.W.I의 App" children={()=> <TabNavigator area={area} getData={getData} /> } />
            ...
            <Stack.Screen name="여행지결과 페이지" children={()=> <ResultPage area={area} getData={getData} />}/>
            {/* <Stack.Screen name="지역 설정 페이지" component={areasetPage} area= {area} /> */}
            {/* <Stack.Screen name="지역 설정 페이지">
                {(props) => <areasetPage {...props} />}
            </Stack.Screen> */}

            <Stack.Screen name="지역 설정 페이지" children={()=> <AreasetPage area={area} getData={getData} /> }/>
        </Stack.Navigator>
    )
}
...
const TabNavigator = ({area,getData}) => {
    ...
    return (
        <Tab.Navigator
            ...
            // children={()=> <MainPage area={area} getData={getData} /> }
            component={MainPage}
                options={{
                    tabBarIcon: ({ focused }) => (
                        <Ionicons
