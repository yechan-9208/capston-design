...
//             <Marker coordinate={P4} onClick={() => console.warn('onClick! p4')} image={favicon} width={48} height={48}/>
...
//                         <Text>Image</Text>
//                     </View>
//                     <ImageBackground source={favicon} style={{width: 64, height: 64}}>
